...
const AppLayout = () => {
  ...
  return (
    <div>
        ...
        <Container fluid >
            <Navbar.Brand href="#"><img style={{width: "100px", cursor: "pointer"}} src='https://beyondthespectrummovie.com/wp-content/uploads/2018/03/Cineplex_logo_sm_white.png'/></Navbar.Brand>
